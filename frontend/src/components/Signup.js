...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post('https://chat-backend-vy78.onrender.com/auth/signup', { email, password });
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold text-center text-indigo-600 mb-6">Signup</h2>
